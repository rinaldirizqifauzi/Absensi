...
<div class="row">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('rkelassatu.absen.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="container">
                            ...
                            <div class="form-group">
                                ...
                                <select name="namasiswa_id" id="namasiswa_id" class="form-control">
                                    ...
                                    @foreach ($kelassatu as $field)
                                        <option value="{{ $field->id }}" selected>{{ $field->nama_siswa }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <option value="Hadir" @if (old('keterangan', $data->keterangan) == "Hadir") {{ 'selected' }} @endif>Hadir</option>
                                <option value="Terlambat" @if (old('keterangan', $data->keterangan) == "Terlambat") {{ 'selected' }} @endif>Terlambat</option>
                                <option value="Tidak Hadir" @if (old('keterangan', $data->keterangan) == "Tidak Hadir") {{ 'selected' }} @endif>Tidak Hadir</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <center>
                                ...
                                <input type="text" name="alasan" id="alasam" class="form-control" value="{{ $data->alasan }}">
                            </div>
                        </div>
                    </div>
                    <div class="container">
